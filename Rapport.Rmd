...
```{r}
#Retirer le '#' devant le fread correspondant à votre chemin en local

#data3 <- fread("tapez votre nom de chemin ici")
...
#Point de la grille avec la bonne proba et concentration
Cd.idw <- as.data.table(Cd.idw)
